...
if __name__ == '__main__':
    ...
    data_qwen = data_qwen[['order_index', 'winner_model_a', 'winner_model_b']]
    data_llama3 = data_llama3[['order_index', 'winner_model_a_2', 'winner_model_b_2']]
    data = data[['order_index','label','text','id','prompt','model_a','model_b','language','fold','reverse']]
    print(data)
